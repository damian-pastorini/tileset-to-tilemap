...
class TilesetsMerge
{
    ...
    async buildTilesetOutput(tileset, outputDir, generateAnnotated)
    {
        ...
        await new AnnotatedImageBuilder().buildAnnotatedImage(
            tileset,
    ...
    buildMergedTilesetState(props)
    {
        return {
            ...
            animationsDefaultDuration: TilesetConst.ANIMATIONS_DEFAULT_DURATION,
            tileAnimations: sc.get(props, 'mergedAnimations', [])
        };
    }
    ...
    async writeMergeOutputFiles(outputDir, mergedName, newTilesetState, generateAnnotated)
    {
        await this.buildTilesetOutput(newTilesetState, outputDir, generateAnnotated);
    ...
    {
        let generateAnnotated = true === sc.get(tilesetsMergeData[0], 'generateAnnotatedImages', false);
        ...
        let mergedAnimations = this.tileAnimationsBuilder.remapForMerge(placements, mergedColumns);
        ...
        await this.writeMergeOutputFiles(outputDir, mergedName, newTilesetState, generateAnnotated);
