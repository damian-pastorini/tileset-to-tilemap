...
class ClusterCropper
{
    ...
    maskTileArea(cropBuffer, cropWidth, tileX, tileY, tileWidth, tileHeight, bgColor, colorThreshold, isClusterTile)
    {
        let channels = 4;
    ...
    {
        let colorThreshold = Number(sc.get(process.env, 'CLUSTER_COLOR_DISTANCE', '30'));
