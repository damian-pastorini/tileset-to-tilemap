...
class TilesetImagePersister
{
    ...
    {
        let inputDir = FileHandler.joinPaths(TilesetConst.ROOT_DIR, 'input', sessionId);
        let oldOutputDir = '';
        let newOutputDir = '';
        if(oldSessionId){
            oldOutputDir = FileHandler.joinPaths(TilesetConst.ROOT_DIR, 'output', oldSessionId);
            newOutputDir = FileHandler.joinPaths(TilesetConst.ROOT_DIR, 'output', sessionId);
        }
